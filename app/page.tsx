      ...
      <main id="top">
        ...
        >
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <Reveal className="rounded-md border border-stahl/40 bg-nacht p-8 md:p-10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="mt-7 inline-block rounded-sm bg-stahl px-8 py-4 text-sm font-bold uppercase tracking-wider text-tinte transition hover:-translate-y-0.5 hover:bg-stahl-hell"
              >
            ...
            <Reveal delay={120} className="rounded-md border border-linie bg-nacht p-8 md:p-10">
